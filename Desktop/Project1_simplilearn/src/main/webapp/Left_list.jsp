...
<div class="sidenav">
	...
	<c:url var="classesLink" value="academic_">
		<c:param name="command" value="CLASSES" />
	</c:url>

	<c:url var="subjectsLink" value="academic_">
		<c:param name="command" value="SUBJECTS" />
	</c:url>

	<c:url var="teachersLink" value="academic_">
		<c:param name="command" value="TEACHERS" />
	</c:url>

	<c:url var="studentsLink" value="academic_">
