     ...
     String accountno=request.getParameter("accountno");
       ...
       ResultSet rs2=ps2.executeQuery();
		...
		if(status==true){
			...
			out.print("<br>YOUR BALANCE HAS INCREASED and the transaction id is:<br>");
			...
			PreparedStatement ps4=con4.prepareStatement("update NEW_ACCOUNT set amount=? where account_no='"+accountno+"'");
