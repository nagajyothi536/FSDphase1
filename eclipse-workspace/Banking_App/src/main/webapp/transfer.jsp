...
<table><%
	   ...
	   try {
		if(status==true){
		    ...
		    %>
			<% 
			out.print("<br> Amount transferred successfully"); 
			...
			PreparedStatement ps7=con7.prepareStatement("update NEW_ACCOUNT set amount=? where account_no='"+taccountno+"'");
            ...
            ps8.setString(1,accountno);
			ResultSet rs8=ps8.executeQuery();
			
			int dataamount1=0;
			if(rs8.next()){
			dataamount1=rs2.getInt(3)-accoun; 
			out.print(dataamount1);
			}
			Connection con3=GetCon.getCon();
			
			PreparedStatement ps3=con3.prepareStatement("update NEW_ACCOUNT set amount=? where account_no='"+accountno+"'");
