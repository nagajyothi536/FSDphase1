...
try {
           ...
           Connection con1=g.GetCon.getCon();
           
			//session.setAttribute("uname",uname);
			
			PreparedStatement ps1=con1.prepareStatement("Select *  from account where account_no='"+account_no+"'");
              ResultSet rs=ps1.executeQuery();
			  if(rs.next()){
			       //response.sendRedirect("createacc.jsp");
			       out.print("request for cheque book has submitted successfully with reference id:"+tid);
